...
"background-image: url(:/photo/561fadc8c3567.jpg);")
        self.label = QtWidgets.QLabel(VIP)
        self.label.setGeometry(QtCore.QRect(70, 50, 61, 20))
        font = QtGui.QFont()
        font.setFamily("微软雅黑")
        font.setPointSize(14)
        ...
        self.label_2 = QtWidgets.QLabel(VIP)
        ...
        self.lineEdit = QtWidgets.QLineEdit(VIP)
        self.lineEdit.setGeometry(QtCore.QRect(150, 50, 151, 20))
        font = QtGui.QFont()
        font.setFamily("微软雅黑")
...
"")
        ...
        self.lineEdit_2 = QtWidgets.QLineEdit(VIP)
...
"")
        ...
        self.layoutWidget = QtWidgets.QWidget(VIP)
        self.layoutWidget.setGeometry(QtCore.QRect(80, 180, 239, 29))
...
"border-radius:6px;")
        ...
        self.graphicsView_2 = QtWidgets.QGraphicsView(VIP)
        self.graphicsView_2.setGeometry(QtCore.QRect(310, 40, 81, 121))
    ...
    def retranslateUi(self, VIP):
        ...
        VIP.setWindowTitle(_translate("VIP", "VIP用户登录"))
        self.label.setText(_translate("VIP", "姓名"))
        self.label_2.setText(_translate("VIP", "身份证号"))
        self.pushButton.setText(_translate("VIP", "确认"))
        self.pushButton_2.setText(_translate("VIP", "注册"))
        self.pushButton_3.setText(_translate("VIP", "取消"))
